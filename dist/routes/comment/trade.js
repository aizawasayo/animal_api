      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 10;
            return _trade_comment["default"].countDocuments(condition);
          ...
          case 10:
            ...
            _context.next = 14;
            return _trade_comment["default"].find(condition).skip(skip).limit(limit).populate('uid').sort(sortCondition).collation({
              locale: 'zh'
            }).exec();
